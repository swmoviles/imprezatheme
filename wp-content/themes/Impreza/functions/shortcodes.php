...
class US_Shortcodes {
    ...
    public function vc_contact_form($attributes, $content = null)
    {
        ...
        $btn_color_class = (@$attributes['button_color'] != '')?' color_'.$attributes['button_color']:'';
        $btn_align_class = (@$attributes['button_align'] != '')?' align_'.$attributes['button_align']:'';
        $outlined_class = (@$attributes['button_outlined'] == 1 OR $attributes['button_outlined'] == 'yes')?' outlined':'';
        ...
        if ($attributes['form_email'] != '') {
            $output .= '<input type="hidden" name="receiver" value="'.$attributes['form_email'].'">';
        }
        if (in_array(@$attributes['form_name_field'], array('required', 'show')) )
        {
            $name_required = (@$attributes['form_name_field'] == 'required')?1:0;
            $name_required_label = '';
            if ($name_required) {
                $name_required_label = ' *';
            }
        ...
        {
            $email_required = (@$attributes['form_email_field'] == 'required')?1:0;
        ...
        {
            $phone_required = (@$attributes['form_phone_field'] == 'required')?1:0;
        ...
        if (in_array(@$attributes['form_message_field'], array('required', 'show')))
        {
            $message_required = (@$attributes['form_message_field'] == 'required')?1:0;
        ...
        if ($attributes['form_captcha'] == 'show') {
            ...
            $output .= '<div class="w-form-row" id="captcha_row">
						...
						<div class="w-form-field">
							<input type="hidden" name="captcha_result" value="'.md5($result.$attributes['captcha_salt']).'">
...
//			$output_type = ' type_background';
    ...
    public function vc_blog($attributes, $content)
    {
        ...
        switch ($attributes['type']) {
            case 'large_image': $classes .= ' imgpos_attop';
                break;
            case 'small_square_image': $classes .= ' imgpos_atleft';
                break;
            case 'small_circle_image': $classes .= ' imgpos_atleft imgtype_circle';
                break;
            case 'masonry':
            case 'masonry_ajax':
            case 'masonry_paginated': $classes .= ' type_masonry imgpos_attop';
                break;
        }
    ...
    public function vc_counter ($attributes, $content)
    {
        ...
        $output = 	'<div class="w-counter'.$color_class.'" data-count="'.$attributes['count'].'" data-prefix="'.$attributes['prefix'].'" data-suffix="'.$attributes['suffix'].'">
