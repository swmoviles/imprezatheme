		...
		<div class="l-submain-h g-html i-cf">
			<div class="w-pagehead<?php echo $header_layout_type; ?>">
				...
				<div class="w-pagehead-nav">
					...
					if( ! empty($prev_item)) {
						?>
						<a class="w-pagehead-nav-item type_prev" href="<?php echo get_permalink($prev_item->ID); ?>" title="<?php echo get_the_title($prev_item->ID); ?>"><i class="fa fa-angle-left"></i></a>
						<?php
					}
					if( ! empty($next_item)) {
						?>
						<a class="w-pagehead-nav-item type_next" href="<?php echo get_permalink($next_item->ID); ?>" title="<?php echo get_the_title($next_item->ID); ?>"><i class="fa fa-angle-right"></i></a>
						<?php
					}
					?>
					</div>
