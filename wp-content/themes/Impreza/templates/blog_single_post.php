...
<div <?php post_class('w-blog-entry') ?>>
	<div class="w-blog-entry-h">
		...
		<div class="w-blog-entry-body">
            ...
            <?php
                if ( ! isset($smof_data['post_read_more']) OR $smof_data['post_read_more'] == 1) { ?><a class="w-blog-entry-more g-btn color_default size_small outlined" href="<?php the_permalink(); ?>"><span><?php echo __('Read More', 'us') ?></span></a><?php }
            } ?>
		</div>
	</div>
</div>