...
?>
<body <?php body_class('l-body '.$theme_class); ?><?php echo  ($body_background_styles_text != '')?' style="'.$body_background_styles_text.'"':''; ?>>
<?php
...
if (@$smof_data['header_is_sticky'] == 1) {
    ...
    if (@$smof_data['header_sticky_type'] == 1) {
...
<div class="l-canvas <?php echo $layout_class.' '.$sidebar_position_class.$extended_header_class.$header_position_class.$lang_class; ?>">
	...
	<!-- HEADER -->
	<div class="l-header<?php echo $logo_pos_class.$header_transparent_class; ?> state_initial">
