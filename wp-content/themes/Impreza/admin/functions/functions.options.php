...
$of_options[] = array( 	"name" 		=> "Import",
	...
	<div class='explain' style='width: 360px;'>If you want to have posts and pages that look like the Impeza Theme Demo, you can import dummy posts and pages here. This will help you start making your own site faster and understand better how the Theme works.</div>
...
$of_options[] = array( 	"name" 		=> "Favicon",
	"desc" => "Upload a 16x16 px ICO/PNG/GIF image that will represent your website's favicon",
	"id" => "custom_favicon",
	"std" => "",
	"type" => "upload");
...
$of_options[] = array( "name" => "Transparent Sticky Header",
	"desc" => "Make the header transparent on its initial position <span class='w-info'>(works at Home page only)</span>",
...
$of_options[] = array( "name" => "",
    ...
    "options" => array(
        ...
        'Extra-Light (200) font weight' => 'Extra-Light (200) font weight',
